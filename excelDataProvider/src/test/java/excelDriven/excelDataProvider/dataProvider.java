...
public class dataProvider {
	...
	//this method will convert excel data into arrays where each array would represent one row of excel sheet
	@DataProvider
	public Object[][] getData() throws IOException {
		...
		//Object[][] is a multi-dimensional array storing multiple arrays with each array representing one row in an excel sheet
		...
		for(int i = 0; i < rowCount-1; i++) {
			...
			for(int j = 0; j < colCount; j++) {
				...
				data[i][j] = formatter.formatCellValue(cell); //formatCellValue will convert the cell value to String no matter what the cell value is initially
			}
		}
